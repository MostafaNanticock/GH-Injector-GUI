...
template <>
bool GetArg<bool>(int argc, const wchar_t *arg, const wchar_t * const argv[], bool DefaultValue);
template <>
DWORD GetArg<DWORD>(int argc, const wchar_t *arg, const wchar_t * const argv[], DWORD DefaultValue);
template <>
UINT GetArg<UINT>(int argc, const wchar_t *arg, const wchar_t * const argv[], UINT DefaultValue);
template <>
std::wstring GetArg<std::wstring>(int argc, const wchar_t *arg, const wchar_t * const argv[], std::wstring DefaultValue);
...
void help()
{
    ...
    printf("\t-cloak\n");
    printf(
        "\t\tCreates the thread cloaked with INJ_CTF_FAKE_START_ADDRESS and INJ_CTF_HIDE_FROM_DEBUGGER. See -cloakflags for more information.\n\n");
